...
class TrainingDataLoader:
    def __init__(self, option, lowerDeltaBound, upperDeltaBound, numCollPointsTrain, numExpPointsTrain, numBoundaryPointsTrain):
        ...
        collPoints, callPrices, gammaWeights = self.option.filterDataByDelta(
            self.lowerDeltaBound, self.upperDeltaBound)
        ...
        boundaryShuffle = torch.randperm(numBoundaryPoints)[
            : self.numBoundaryPointsTrain]
